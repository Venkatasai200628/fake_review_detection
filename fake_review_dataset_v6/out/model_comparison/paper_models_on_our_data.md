...
|---|---|---|---|---|---|---|---|---|---|
| 02 Shan 2021 | Shan inconsistency + RF | 0.767 | 0.725 | 0.802 | 0.699 | 5% | 79% | 8.1% | 140 / 11 (p=1.2e-29) |
| 15 Xu 2024 | A-LSTM + behaviour | 0.749 | 0.747 | 0.832 | 0.759 | 22% | 100% | 24.2% | 180 / 37 (p=9.4e-24) |
| 38 Qayyum 2023 | FRD-LSTM (DCWR + BiLSTM) | 0.817 | 0.787 | 0.848 | 0.764 | 2% | 100% | 4.0% | 119 / 31 (p=2.3e-13) |
| 39 Duma 2024 | DHMFRD-TER (text + emotion + rating) | 0.783 | 0.768 | 0.829 | 0.744 | 16% | 100% | 15.3% | 154 / 38 (p=9.2e-18) |
| 30 Lu 2023 | BSTC (BERT + TextCNN) | 0.835 | 0.802 | 0.847 | 0.771 | 1% | 100% | 0.0% | 106 / 32 (p=1.9e-10) |
| 40 Geetha 2025 | DeBERTa-v3 fine-tuned | 0.822 | 0.795 | 0.853 | 0.776 | 7% | 100% | 4.7% | 118 / 34 (p=4.6e-12) |
| 11 Hou 2025 | FRIDRC (text enc. + ViT, fused) | 0.832 | 0.799 | 0.839 | 0.767 | 0% | 100% | 0.2% | 108 / 32 (p=7.8e-11) |
| **ours** | **forensic fusion** | **0.926** | **0.922** | **0.966** | **0.954** | **79%** | 83% | 2.2% | – |
